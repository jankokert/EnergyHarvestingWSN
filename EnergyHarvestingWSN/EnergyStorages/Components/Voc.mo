...
equation
  Voc = cellParam.E0 - cellParam.Elin * (1 - Q/C) - cellParam.Epol * C/Q + cellParam.Av * exp(-cellParam.Bv * (C-Q));
  // protection for div by 0 (1/C) not needed, as Rint will never completly deplete the battery
annotation(
    Diagram,
