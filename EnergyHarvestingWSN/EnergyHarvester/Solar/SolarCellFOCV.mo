...
model SolarCellFOCV
  ...
  EnergyHarvestingWSN.EnergyHarvester.Solar.SolarCell solarCell(A = A, Jsc = Jsc, cellparam = cellparam)  annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  EnergyHarvestingWSN.EnergyHarvester.Solar.SolarCell pilotCell(A = A, Jsc = Jsc, cellparam = cellparam)  annotation(
