...
equation
  ...
  connect(Gin.n, n) annotation(
    Line(points = {{-70, -20}, {-70, -80}, {0, -80}, {0, -100}}, color = {0, 0, 255}));
  connect(pin, Gin.p) annotation(
    Line(points = {{-100, 60}, {-70, 60}, {-70, 0}}, color = {0, 0, 255}));
  connect(startStop.gout, Gin.G) annotation(
    Line(points = {{-31, -10}, {-59, -10}}, color = {0, 0, 127}));
  ...
  connect(Gin.pin, efficiency.pin) annotation(
    Line(points = {{-62, -20}, {-62, -50}, {-32, -50}}, color = {0, 0, 127}));
  connect(pout, Iout_src.n) annotation(
    Line(points = {{100, 60}, {70, 60}, {70, -40}, {70, -40}}, color = {0, 0, 255}));
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Line(origin = {-84, -11}, points = {{0, 31}, {0, -29}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Text(origin = {-89, -9}, lineColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Vin", fontSize = 12), Text(origin = {9, 33}, lineColor = {0, 0, 127}, extent = {{-10, -2}, {10, 2.5}}, textString = "feedback", horizontalAlignment = TextAlignment.Left), Text(origin = {16, -7}, lineColor = {0, 0, 127}, extent = {{-10, -2}, {10, 2.5}}, textString = "Gcontrol", horizontalAlignment = TextAlignment.Left), Text(origin = {87, -51}, lineColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Vout", fontSize = 12), Line(origin = {79.7835, -41.5422}, points = {{0, 21}, {0, -39}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Line(origin = {69.2961, 47.1386}, points = {{-2, 17}, {16, 17}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Text(origin = {75, 69}, lineColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Iout", fontSize = 12), Text(origin = {-83, 69}, lineColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Iout", fontSize = 12), Line(origin = {-88.4727, 47.1386}, points = {{-2, 17}, {16, 17}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Text(origin = {-38, -47}, lineColor = {0, 0, 127}, extent = {{-4, -2}, {4, 2.5}}, textString = "Pin", horizontalAlignment = TextAlignment.Left), Text(origin = {10, -47}, lineColor = {0, 0, 127}, extent = {{-4, -2}, {4, 2.5}}, textString = "Pout", horizontalAlignment = TextAlignment.Left)}),
