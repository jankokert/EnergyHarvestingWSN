...
equation
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1), graphics = {Line(origin = {-70.1077, -30.5827}, points = {{0, 19}, {0, -21}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Text(origin = {-75, -29}, textColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Vin", fontSize = 12), Text(origin = {9, 33}, textColor = {0, 0, 127}, extent = {{-10, -2}, {10, 2.5}}, textString = "feedback", horizontalAlignment = TextAlignment.Left), Text(origin = {16, -7}, textColor = {0, 0, 127}, extent = {{-10, -2}, {10, 2.5}}, textString = "Gcontrol", horizontalAlignment = TextAlignment.Left), Text(origin = {87, -51}, textColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Vout", fontSize = 12), Line(origin = {79.7835, -41.5422}, points = {{0, 11}, {0, -29}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Line(origin = {69.2961, 47.1386}, points = {{-2, 17}, {16, 17}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Text(origin = {75, 69}, textColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Iout", fontSize = 12), Text(origin = {-83, 69}, textColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Iin", fontSize = 12), Line(origin = {-88.4727, 47.1386}, points = {{-2, 17}, {16, 17}}, color = {0, 136, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Text(origin = {-38, -47}, textColor = {0, 0, 127}, extent = {{-4, -2}, {4, 2.5}}, textString = "Pin", horizontalAlignment = TextAlignment.Left), Text(origin = {10, -47}, textColor = {0, 0, 127}, extent = {{-4, -2}, {4, 2.5}}, textString = "Pout", horizontalAlignment = TextAlignment.Left), Text(origin = {21, -92}, textColor = {0, 0, 255}, extent = {{-12, -2.8}, {12, 2.8}}, textString = "(ground)", horizontalAlignment = TextAlignment.Left), Line(origin = {-70, 0}, points = {{-30, 0}, {0, 0}, {0, 44}, {47, 44}}, color = {0, 170, 0}, arrow = {Arrow.None, Arrow.Open}), Text(origin = {-83, 5}, textColor = {0, 136, 0}, extent = {{-7, -3}, {7, 3}}, textString = "Vmpp", fontSize = 12)}),
