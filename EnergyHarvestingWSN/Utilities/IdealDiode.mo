...
<li><i>some years ago   </i>
    ...
    Polygon(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{30, 0}, {-30, 40}, {-30, -40}, {30, 0}}),
    ...
    Polygon(lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{70, 4}, {80, 0}, {70, -4}, {70, 4}}),
    Line(points = {{0, 80}, {0, -80}}, color = {128, 128, 128}),
    Polygon(lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{-4, 70}, {0, 80}, {4, 70}, {-4, 70}}),
    Text(lineColor = {128, 128, 128}, extent = {{10, 80}, {20, 70}}, textString = "i"),
    Text(lineColor = {128, 128, 128}, extent = {{70, -10}, {80, -20}}, textString = "v"),
    Line(points = {{-80, -40}, {-20, -10}, {20, 10}, {40, 70}}, thickness = 0.5),
    Line(points = {{20, 9}, {20, 0}}, color = {128, 128, 128}, pattern = LinePattern.Dot),
    Text(lineColor = {128, 128, 128}, pattern = LinePattern.Dot, extent = {{20, 0}, {40, -10}}, textString = "Vknee"),
    Text(lineColor = {128, 128, 128}, pattern = LinePattern.Dot, extent = {{20, 70}, {40, 60}}, textString = "Ron"),
    Text(lineColor = {128, 128, 128}, pattern = LinePattern.Dot, extent = {{-20, 10}, {0, 0}}, textString = "Goff"),
    Ellipse(lineColor = {0, 0, 255}, pattern = LinePattern.Dot, extent = {{18, 12}, {22, 8}}, endAngle = 360)}));
end IdealDiode;
