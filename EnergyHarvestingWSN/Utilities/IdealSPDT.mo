...
model IdealSPDT "An ideal Single Pole Double Throw toggle switch"
  ...
  Modelica.Blocks.Interfaces.BooleanInput control "true => p--n2 connected, false => p--n1 connected" annotation(
...
//n1.i*Ron;
 ...
 <li><i> 1998   </i>
    ...
    Ellipse(lineColor = {0, 0, 255}, extent = {{-44, 4}, {-36, -4}}, endAngle = 360),
